package br.com.alurafood.promotions.config;
...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, PromotionDto> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PromotionDto> kafkaTemplate() {
